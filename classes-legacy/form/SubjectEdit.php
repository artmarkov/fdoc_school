...
class form_SubjectEdit extends \main\forms\ObjEdit
{
    ...
    public function __construct($obj, $url)
    {
        ...
        $this->addField('form_control_Select2', 'department', 'Учебное отделение', ['refbook' => 'department', 'required' => 1, 'hint' => 'Выберете отделения в которых преподается данная дисциплина']);

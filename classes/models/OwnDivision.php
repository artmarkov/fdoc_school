...
/**
 * This is the model class for table "own_division".
 *
 * @property int $id
 ...
 */
class OwnDivision extends ActiveRecord
{
    ...
    public static function getOwnDivisionList()
    {
      return  OwnDivision::find()->select(['name', 'id'])->indexBy('id')->column();
    }
